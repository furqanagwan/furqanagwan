...
export function Header() {
  return (
    <header className="mb-16 space-y-4">
      <h1 className="text-4xl font-bold mb-4 animate-fade-in text-black dark:text-white">
        <span className="inline-block">
          <ScrambleText text="furqan agwan" />
        </span>
      </h1>
      <div className="flex flex-col gap-2 text-gray-700 dark:text-gray-400">
      ...
      {/* <p className="leading-relaxed animate-fade-in-up text-gray-700 dark:text-gray-300">
