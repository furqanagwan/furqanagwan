...
// Default categories - kept for reference but actual categories come from props
const _defaultCategories = [
  ...
  { label: "Security", href: "/blog?category=security" },
  { label: "Global Affairs", href: "/blog?category=global%20affairs" },
];
