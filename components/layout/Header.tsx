...
export default function Header() {
  const { toggle, toggleMobileMenu } = useSidebar();
        ...
        <div className="w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-black/40 dark:text-white/40 bg-transparent text-center p-2 md:hidden hover:text-black dark:hover:text-white transition-colors"
            >
              <SidebarToggleIcon className="w-[18px] h-[18px]" />
            </button>
