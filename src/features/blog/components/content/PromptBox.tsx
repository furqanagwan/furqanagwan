...
export function PromptBox({ children, icon = false }: PromptBoxProps) {
  return (
    <div className="my-6 bg-black/5 dark:bg-white/5 rounded-xl p-4 md:p-5">
      <div className="flex items-start gap-3">
        ...
        <div className="text-[15px] leading-relaxed text-black/80 dark:text-white/80">
          {children}
        </div>
      </div>
    </div>
