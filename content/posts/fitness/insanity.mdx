...
- Rotate: _Cardio Challenge_, _Tabata Strength_, _Sweat Intervals_, _Friday Fight_
- Occasionally: _Pulse_ for active recovery
- Always:
...
- **Motivation:** Recovery time gets faster = progress I can _see_.
