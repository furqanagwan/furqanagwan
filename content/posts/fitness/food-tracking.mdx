...
<Lead>
  Tracking your food isn’t rocket science—but doing it well is a game changer.
  Here’s how I figured out calorie and macro tracking without losing my mind,
  the apps I tried (spoiler: MacroFactor wins), and the simple workflow that
  keeps results coming.
</Lead>
...
**Back in the day**, MyFitnessPal (MFP) was basically _the_ tool everyone used to get a handle on nutrition. Huge database, easy barcode scanning, and totally free (for a while).
